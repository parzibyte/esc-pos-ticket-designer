...
<template>
    <div class="inline-block" v-if="estaConectado">
        <div class="flex flex-row items-center">
            ...
            <p class="text-green-600 ml-1">{{ estaConectado.detalles.plataforma }} {{ estaConectado.detalles.version }} ({{
                estaConectado.detalles.sistemaOperativo }})</p>
        </div>
    </div>
    <div class="inline-block" v-if="!estaConectado">
        <div class="flex flex-row items-center">
