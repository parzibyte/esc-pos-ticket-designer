...
const clasesParaContenedor = () => {
  return { "w-3/4": mostrarMenu.value, "w-full": !mostrarMenu.value };
}
</script>
...
<template>
  ...
  <div class="flex flex-row">
    <div class="flex flex-col border border-r-gray-200 font-semibold text-gray-700" v-show="mostrarMenu"
